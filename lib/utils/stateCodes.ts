// Mapping of state names to 2-letter codes for joining GeoJSON with CDC data
export const STATE_NAME_TO_CODE: { [name: string]: string } = {
  'Alabama': 'AL',
  'Alaska': 'AK',
  'Arizona': 'AZ',
  'Arkansas': 'AR',
...
export const STATE_CODE_TO_NAME: { [code: string]: string } = Object.fromEntries(
